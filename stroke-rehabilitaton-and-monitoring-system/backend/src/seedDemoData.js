...
const seedDemoData = async () => {
  ...
  const patientDocs = [];
  const patients = [
    { userId: mercy?._id, patientId: 'p1', name: 'Mercy Banda', avatar: 'MB', age: 62, condition: 'Ischemic Stroke', admitDate: '2026-01-10', rehabStart: '2026-01-12', progress: 60, streak: 7, totalSessions: 12, targetSessions: 30, risk: 'moderate', focus: ['Upper Limb', 'Speech'], caregiverId: 'c1', doctorId: 'd1', patientEntered: true, strokeType: 'Ischemic Stroke', strokeDate: 'Jan 5, 2026', affectedSide: 'Right', initialSymptoms: 'Sudden weakness in right arm and leg, difficulty speaking.', preExistingConditions: 'Hypertension, Type 2 Diabetes', allergies: 'Penicillin', familyHistory: 'Father had stroke at 68', rehabGoals: 'Regain right arm movement, walk independently', preferredDays: 'Monday, Wednesday, Friday', mobilityLevel: 'minimal assistance', speechStatus: 'mild impairment', cognitiveStatus: 'normal' },
    { userId: null, patientId: 'p2', name: 'Grace Phiri', avatar: 'GP', age: 55, condition: 'Hemorrhagic Stroke', admitDate: '2026-02-20', rehabStart: '2026-02-22', progress: 35, streak: 3, totalSessions: 6, targetSessions: 30, risk: 'high', focus: ['Lower Limb', 'Balance'], caregiverId: 'c2', doctorId: 'd1', patientEntered: false },
    { userId: null, patientId: 'p3', name: 'Peter Mwansa', avatar: 'PM', age: 70, condition: 'Transient Ischemic Attack', admitDate: '2026-03-05', rehabStart: '2026-03-07', progress: 80, streak: 14, totalSessions: 20, targetSessions: 30, risk: 'low', focus: ['Cognitive', 'Upper Limb'], caregiverId: 'c3', doctorId: 'd1', patientEntered: false },
  ];
