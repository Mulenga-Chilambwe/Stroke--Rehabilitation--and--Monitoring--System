...
export const INITIAL_PATIENTS = [
  {
    ...
    strokeDate: 'Jan 5, 2026',
    affectedSide: 'Right',
    initialSymptoms: 'Sudden weakness in right arm and leg, difficulty speaking, facial drooping on right side.',
    preExistingConditions: 'Hypertension (diagnosed 2018), Type 2 Diabetes (2020)',
    allergies: 'Penicillin (rash)',
    familyHistory: 'Father had stroke at 68, mother has hypertension',
    rehabGoals: 'Regain full right arm movement, walk independently without cane, improve speech clarity',
    preferredDays: 'Monday, Wednesday, Friday - mornings preferred',
    mobilityLevel: 'minimal assistance',
    speechStatus: 'mild impairment',
...
export const INITIAL_CAREGIVERS = [
  { id: 'c1', name: 'John Banda', avatar: 'JB', relation: 'Son', phone: '+260 97X XXX XXX', patientId: 'p1', doctorId: 'd1', bio: 'Full-time caregiver for my mother Mercy.' },
  { id: 'c2', name: 'Martha Phiri', avatar: 'MP', relation: 'Sister', phone: '+260 96X XXX XXX', patientId: 'p2', doctorId: 'd1', bio: 'Caring for my sister Grace during her recovery.' },
  { id: 'c3', name: 'Ruth Mwansa', avatar: 'RM', relation: 'Spouse', phone: '+260 95X XXX XXX', patientId: 'p3', doctorId: 'd1', bio: 'Supporting my husband Peter through rehabilitation.' },
];
...
export const INITIAL_DOCTORS = [
  {
    ...
    yearsOfExperience: 15,
    officeLocation: 'CBU Teaching Hospital, Wing B, Room 204',
    bio: 'Specialist in neurorehabilitation with over 15 years of clinical experience in stroke recovery.',
    isAvailable: true,
  },
];
